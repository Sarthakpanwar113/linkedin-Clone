  ...
  return (
    <div>
      <div
        ...
        style={{
          backgroundImage:
            "url(https://avatars.githubusercontent.com/u/92731861?v=4)",
        }}
      ></div>
      <div className="flex justify-center">
        <img
          className="w-16 h-16 rounded-full overflow-hidden border-white border-2 mt-[-32px] z-1"
          src="https://avatars.githubusercontent.com/u/92731861?v=4"
        />
      </div>
    </div>
  );
...
const MyProfileProfession = () => {
  return (
    <a
      ...
      href="https://www.linkedin.com/in/sarthak-panwar-b13a32217/"
      target="_blank"
    >
